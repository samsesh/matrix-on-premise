...
- **Fast startup with service dependencies**: Services start in proper order (coturn → synapse → element/element-call/synapse-admin) but don't wait for health checks, enabling faster startup
